...
namespace SolakGymDnevnik.SolakGymDnevnikDbDataSetTableAdapters {
    ...
    public partial class MemberTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Member] WHERE (([Id] = @Original_Id) AND ([MembershipNumber] = @Original_MembershipNumber) AND ([Name] = @Original_Name) AND ([PhoneNumber] = @Original_PhoneNumber) AND ([MembershipDuration] = @Original_MembershipDuration) AND ([ExpirationTime] = @Original_ExpirationTime))";
...
SELECT Id, MembershipNumber, Name, PhoneNumber, MembershipDuration, ExpirationTime FROM Member WHERE (Id = @Id)";
        ...
        public virtual int Delete(int Original_Id, int Original_MembershipNumber, string Original_Name, string Original_PhoneNumber, System.DateTime Original_MembershipDuration, int Original_ExpirationTime) {
            this.Adapter.DeleteCommand.Parameters[0].Value = ((int)(Original_Id));
            this.Adapter.DeleteCommand.Parameters[1].Value = ((int)(Original_MembershipNumber));
            ...
            this.Adapter.DeleteCommand.Parameters[4].Value = ((System.DateTime)(Original_MembershipDuration));
            this.Adapter.DeleteCommand.Parameters[5].Value = ((int)(Original_ExpirationTime));
